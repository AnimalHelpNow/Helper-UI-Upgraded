...
(function ($) {
  Drupal.behaviors.HelperUI = {
    attach: function (context, settings) {
      ...
      //if ((Drupal.settings.userRoles.indexOf('3') >= 0) && (Drupal.settings.userRoles.indexOf('4') >= 0) &&
      //    (Drupal.settings.userRoles.indexOf('5') >= 0) && (Drupal.settings.userRoles.indexOf('6') >= 0)) {
      ...
      if (!fieldRestrictions) {
        ...
        $("input#edit-field-oldhelperid-und-0-value").attr("disabled", "disabled");
        $("input#edit-field-oldhelperid-und-0-value").css("background", "#EEEEEE");
        $("select#edit-field-helpertype-id-und").attr("disabled", "disabled");
        $("select#edit-field-helpertype-id-und").css("background", "#EEEEEE");
        $("input#edit-field-donotdisplay-und").attr("disabled", "disabled");
        $("input#edit-field-donotdisplay-und").css("background", "#EEEEEE");
        $("input#edit-field-hoursknown-und").attr("disabled", "disabled");
        $("input#edit-field-hoursknown-und").css("background", "#EEEEEE");
        $("input#edit-field-geoposition-und-0-value").attr("disabled", "disabled");
        $("input#edit-field-geoposition-und-0-value").css("background", "#EEEEEE");
      ...
      $("div#edit-field-hours-available", context).change('HelperUI', function () {
        ...
        // Disable the coded hours fiels because user is using the daily hours fields.
